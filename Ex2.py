...
# %%
import pickle
#with open("precision_evolution_Ex2.txt", "wb") as fp:   
#    pickle.dump(precision_evolution, fp)
#with open("recall_evolution_Ex2.txt", "wb") as fp:   
#    pickle.dump(recall_evolution, fp)
#with open("F1score_evolution_Ex2.txt", "wb") as fp:   
#    pickle.dump(F1score_evolution, fp)    
with open("F1score_evaluation_Ex2.txt", "rb") as fp:   # Unpickling
    b = pickle.load(fp)   
with open("precision_evaluation_Ex2.txt", "rb") as fp:   # Unpickling
    b = pickle.load(fp)
with open("recall_evaluation_Ex2.txt", "rb") as fp:   # Unpickling
    b = pickle.load(fp)
 
plt.figure()
plt.plot(F1score_evolution, 'r', label='f1 score' )
plt.plot(precision_evolution, color='orange', linestyle='--', label= 'precision')
plt.plot(recall_evolution, 'g--', label='recall')
